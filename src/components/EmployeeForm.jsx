        ...
        <div className="card p-5 sm:p-6">
            ...
            text-sm text-slate-700">
                <div>
                    ...
                    <input type="firstName" required defaultValue={initialData?.firstName}/>
                </div>
                <div>
                    <label className="block mb-2">Last Name</label>
                    <input type="lastName" required defaultValue={initialData?.lastName}/>
                </div>
                <div>
           ...
           text-slate-700">
            ...
            <div>
                ...
                <div>
                    ...
                    <input type="Salary" required min="0" step="0.01" defaultValue={initialData?.basicSalary || 0}/>
                </div>
                <div>
                    <label className="block mb-2">Allowance</label>
                    <input type="number"  name="allowances" min="0" step="0.01" required defaultValue={initialData?.allowance || 0}/>
                </div>
                <div>
