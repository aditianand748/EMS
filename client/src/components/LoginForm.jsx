          ...
          <form className='space-y-5' onSubmit={handleSubmit}>
            ...
            text-slate-700 mb-2'>Password</label>
              <div className='relative'>
                <input type={showPassword ? 'text' : 'password'} onChange={(e) => setPassword(e.target.value)} required className='pr-11'
                  placeholder='........' />
                <button type='button' className='absolute right-3 top-1/2 -translate-y-1/2 
            text-slte-400 hover:text-slate-600 transition-colors' onClick={() =>
                    setShowPassword(!showPassword)
                  }>

                  {showPassword ? <EyeSlashIcon size={18} />
                    : <EyeIcon size={18} />
                  }
